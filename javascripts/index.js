...
var main = function() {
    ...
    window.onscroll = function() {
        ...
        if ($(window).scrollTop() != 0) {
            ...
            $('.nav > li > a').stop().animate({color:'#60695C'}, {duration:300});
            fork.stop().animate( {height: '60px', borderRadius: "0", right: "0"}, {duration:300});
            fork.css("box-shadow","none");
            if (isFirefox) {
                $('#forkme_banner > p').css( {margin: "10px 0"}, {duration:300});
            }
            else {
            ...
            $('.nav > li > a').stop().animate({color:'#FFF'}, {duration:300});
            ...
            if (isFirefox) {
                $('#forkme_banner > p').css( {margin: "0"}, {duration:300});
            }
            else {
